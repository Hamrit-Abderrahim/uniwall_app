...
class ProcessCib extends StatefulWidget {
  const ProcessCib({super.key});

  @override
  State<ProcessCib> createState() => _ProcessCibState();
}

class _ProcessCibState extends State<ProcessCib> {
  double progress = 0.0;
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Image(image: AssetImage('assets/wallet/cib.png')),
              Padding(
