...
import 'package:uniwal_app/features/services/widget/done.dart';
          ...
          child: Column(
            ...
            children: [
                        ...
                        child: Column(
                          ...
                          children: [
                            Container(
                              ...
                              decoration: BoxDecoration(),
                              child: Image(
                                  image: AssetImage('assets/wallet/Icon.png')),
                            ),
                            const SizedBox(height: 16),
                            SizedBox(
                              width: double.infinity,
                              child: Text(
                                'Order received! We\'re preparing your \n items\n Estimated completion time:',
              ...
              CustomButton(
                  ...
                  text: 'Done',
                  onTap: () {
                    Navigate.navigateAndReplace(context, Done());
                  })
            ],
          ),
        ),
